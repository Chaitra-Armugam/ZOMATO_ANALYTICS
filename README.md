...
![Zomato Analytics Dashboard](screenshots/ZOMATO_ANALYTICS_DASHBOARD.png)
...
![Zomato Tableau Dashboard](screenshots/ZOMATO_ANALYTICS_TABLEAU_DASHBOARD.png)

### Tableau Project Files

- `Zomato_Analysis_Tableau.twbx` — Tableau workbook containing the dashboard and analysis.
